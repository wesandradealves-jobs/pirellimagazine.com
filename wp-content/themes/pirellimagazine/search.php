...
<section class="webdoor">
    ...
    <h3 class="title">Você encontrou <?php echo $search ->found_posts; ?> resultados para: '<?php echo get_search_query(); ?>'</h3>
</section>
    ...
    <div class="content-wrapper">
        ...
        <?php endwhile; 
            ...
            <?php if(!$search ->found_posts) : ?>
                <li><p><center>Nenhum resultado encontrado.</center></p></li>
            <?php endif; ?>                            
        </ul>
        <?php 
